...
SAVE_PATH = SHARPSHOOTER_DIR / "rf" / "combined_eval"
MODEL_NAME = "rf"
...
def main() -> None:
    ...
    print("Loading sharpshooter data for combined-label RF evaluation...")
    data = DataImport(
        DATA_PATH,
        filetype=".parquet",
        exclude=EXCLUDE,
    ...
    print("Combined-label RF evaluation complete.")

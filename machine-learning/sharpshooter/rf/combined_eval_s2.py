...
SAVE_PATH = SHARPSHOOTER_DIR / "rf" / "combined_eval_s2"
MODEL_NAME = "rf"
...
def main() -> None:
    ...
    print("Loading sharpshooter data for combined-label RF evaluation (combined_eval_s2)...")
    data = DataImport(
        DATA_PATH,
        filetype=".parquet",
        exclude=EXCLUDE,
    ...
    print("Combined-label RF evaluation complete (combined_eval_s2).")

#!/bin/bash
#SBATCH --job-name=epg_rf_chunked_eval  # Name of the job - evaluation with optimized hyperparameters
...
mkdir -p /home/eyoung4-swat/hmc-epg-project/machine-learning/mosquito/eliIntroLabsResults/subwindowOpt
...
# Using optimized hyperparameters from Trial 46 (F1=0.4904)
...
uv run --extra cu129 model_eval.py --data_path /data/labs/hopelab/epg/tarsalis_data_clean \
    --save_path /home/eyoung4-swat/hmc-epg-project/machine-learning/mosquito/eliIntroLabsResults/subwindowOpt --model_path rf_overlappingChunkedFeatures.py --model_name=rf_chunked_subwindows_optimized

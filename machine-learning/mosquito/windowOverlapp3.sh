#!/bin/bash
#SBATCH --job-name=epg_rf_overlapping3  # Name of the job
...
uv run --extra cu129 model_eval.py --data_path /data/labs/hopelab/epg/tarsalis_data_clean \
    --save_path /home/eyoung4-swat/hmc-epg-project/machine-learning/mosquito/eliIntroLabsResults/tarsalis_results_overlapping3 --model_path rf_overlappingFeatures.py --model_name=rf_overlappingFeatures3 --optuna

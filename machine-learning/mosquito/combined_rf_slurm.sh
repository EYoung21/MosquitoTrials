#!/bin/bash
#SBATCH --job-name=epg_combined_rf_optuna  # Name of the job - combined RF with Optuna optimization
...
# Run your Python script with Optuna hyperparameter optimization for combined RF model
uv run --extra cu129 model_eval.py --data_path /data/labs/hopelab/epg/tarsalis_data_clean \
    --save_path /home/eyoung4-swat/hmc-epg-project/machine-learning/mosquito/eliIntroLabsResults/tarsalis_results_combined_rf --model_path combined_rf.py --model_name=combined_rf --optuna

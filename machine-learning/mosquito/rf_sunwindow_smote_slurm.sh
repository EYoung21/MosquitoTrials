#!/bin/bash
#SBATCH --job-name=epg_rf_smote_optuna  # Name of the job - SMOTE with Optuna optimization
...
# Run your Python script with Optuna hyperparameter optimization for SMOTE model
uv run --extra cu129 model_eval.py --data_path /data/labs/hopelab/epg/tarsalis_data_clean \
    --save_path /home/eyoung4-swat/hmc-epg-project/machine-learning/mosquito/eliIntroLabsResults/tarsalis_results_smote --model_path rf_sunwindow_smote.py --model_name=rf_sunwindow_smote --optuna

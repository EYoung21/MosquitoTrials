...
#SBATCH --output=/home/clin4-swat/hmc-epg-project/machine-learning/mosquito/logs/%x_%A_%a.out
#SBATCH --error=/home/clin4-swat/hmc-epg-project/machine-learning/mosquito/logs/%x_%A_%a.err
#SBATCH --gres=gpu:1
...
#   mkdir -p /home/clin4-swat/hmc-epg-project/machine-learning/mosquito/logs

# Make fold-specific save path to avoid collisions between array tasks
SAVE_BASE="/home/clin4-swat/hmc-epg-project/machine-learning/mosquito/results"
...
# Store wandb logs under your mosquito project directory.

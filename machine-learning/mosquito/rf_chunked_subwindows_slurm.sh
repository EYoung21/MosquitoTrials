#!/bin/bash
#SBATCH --job-name=epg_rf_chunked_subwindows  # Name of the job - distinctive for subwindow/chunked features
...
# Run your Python script with Optuna hyperparameter optimization for chunked subwindow features
uv run --extra cu129 model_eval.py --data_path /data/labs/hopelab/epg/tarsalis_data_clean \
    --save_path /home/eyoung4-swat/hmc-epg-project/machine-learning/mosquito/eliIntroLabsResults/tarsalis_results_chunked_subwindows --model_path rf_overlappingChunkedFeatures.py --model_name=rf_chunked_subwindows --optuna
